...
const AddGameType = () => {
  ...
  const fetchGameTypes = async () => {
    try {
      ...
      const res = await fetch("https://uefn-maps-server.vercel.app/api/v1/game-types");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = isEditing
        ? `https://uefn-maps-server.vercel.app/api/v1/game-types/${editId}`
        : "https://uefn-maps-server.vercel.app/api/v1/game-types/create-game-type";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await fetch(`https://uefn-maps-server.vercel.app/api/v1/game-types/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
