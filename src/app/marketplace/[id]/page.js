          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 py-2">
                <div className="flex flex-col">
                  <span className="text-[10px] text-gray-500 uppercase font-black">Price</span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-background p-4 rounded-2xl border border-white/5 flex items-center gap-3 shadow-lg">
                ...
                <div>
                  <p className="text-[9px] text-gray-500 uppercase font-black">Seller</p>
                  <p className="text-xs font-bold truncate">{product.seller?.name}</p>
                </div>
              </div>
              <div className="bg-background p-4 rounded-2xl border border-white/5 flex items-center gap-3 shadow-lg">
                <Calendar size={20} className="text-purple-500" />
                <div>
                  <p className="text-[9px] text-gray-500 uppercase font-black">Released</p>
                  <p className="text-xs font-bold">
                    {new Date(product.createdAt?.$date || product.createdAt).toLocaleDateString()}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="flex items-center justify-center gap-6 text-gray-500 text-[10px] font-black uppercase tracking-widest">
                <span className="flex items-center gap-1">
                  <CheckCircle size={12} className="text-green-500" /> Instant Access
                </span>
                <span className="flex items-center gap-1">
                  <CheckCircle size={12} className="text-green-500" /> Verified Files
                </span>
              </div>
            </div>
          </div>
              ...
              {product.faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {openFaq === index ? (
                      <ChevronUp className="text-purple-500 shrink-0" size={24} />
                    ) : (
