...
const NotFound = () => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6 relative overflow-hidden text-foreground font-sans">
      ...
      <div className="text-center relative z-10">
        ...
        >
          <div className="w-24 h-24 bg-background border border-white/5 rounded-3xl flex items-center justify-center backdrop-blur-md">
            <Gamepad2 size={48} className="text-purple-500" />
          </div>
        </motion.div>

        {/* Error Code */}
        <h1 className="text-[12rem] font-black leading-none tracking-tighter text-foreground/5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none z-[-1]">
          404
        </h1>
        ...
        >
          <Link href="/">
            <button className="flex items-center gap-2 bg-white text-black px-8 py-4 rounded-2xl font-black hover:bg-purple-600 hover:text-foreground transition-all shadow-xl active:scale-95 group">
      ...
      {/* Footer Decoration */}
      <div className="absolute bottom-10 left-10 text-[10px] font-black text-foreground/10 uppercase tracking-[0.5em] rotate-90 origin-left hidden md:block">
