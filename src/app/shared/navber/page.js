        ...
        <div className="relative flex-1 max-w-md group">
          ...
          <div className="relative flex items-center h-10 w-full transition-all duration-300 focus-within:ring-2 focus-within:ring-purple-500/50 rounded-xl bg-white/5 border border-white/10 overflow-hidden">
            ...
            <input
              ...
              placeholder="Search assets..."   className="w-full h-full bg-transparent pl-10 pr-4 text-sm text-white placeholder:text-forground outline-none transition-all border border-border-color rounded-2xl"
            />
          </div>
