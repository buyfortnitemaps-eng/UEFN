    ...
    <footer className="bg-background border-t border-border-color pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-border-color flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-6 border-y sm:border-y-0 sm:border-x border-border-color/50 py-4 sm:py-0 px-6">
            {/* Label */}
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-[11px] sm:text-xs font-bold text-gray-500 hover:text-green-500 transition-all duration-300 group"
              >
                <div className="w-6 h-6 sm:w-5 sm:h-5 rounded-full bg-green-500/10 flex items-center justify-center group-hover:bg-green-500 group-hover:shadow-[0_0_10px_rgba(34,197,94,0.4)] transition-all">
                  <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-[11px] sm:text-xs font-bold text-gray-500 hover:text-[#1dbf73] transition-all duration-300 group"
              >
                <div className="w-6 h-6 sm:w-5 sm:h-5 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#1dbf73] group-hover:border-transparent group-hover:shadow-[0_0_10px_rgba(29,191,115,0.4)] transition-all">
